...
setTimeout(function() {
		...
		fireWorkTimer1 = setInterval(function() {
...
fireWorkTimer2 = setInterval(function() {
	
		fireworks.push(new Firework(width / 2, height, 0, -9.5, 10, "gold", true));

}, 5000);

//运行2分钟后清除所有的定时器（清除烟花效果）
setTimeout(function () {
	
		window.clearInterval(fireWorkTimer1);
		window.clearInterval(fireWorkTimer2);
